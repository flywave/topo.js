/*==============================================================================
# NLopt WASM configuration header
#
# Hand-adapted from the macOS CMake-generated nlopt_config.h for use with
# Emscripten (WASM) builds. All checks verified against Emscripten's libc.
#============================================================================*/
...
/* WASM is 32-bit: sizeof(unsigned long) = 4 (unlike 64-bit macOS where it = 8) */
...
/* Define to C thread-local keyword, or to nothing if this is not supported in
   your compiler. Emscripten supports __thread with -pthread. */
